    ...
    >
      ...
      <View style={styles.View_2_60}>
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/7a62a1c9-bba3-41b9-9bc1-3b7907bdd08e"
          }}
          style={styles.ImageBackground_2_61}
        />
        <View style={styles.View_2_4713}>
          <Text style={styles.Text_2_4713}>For Teacher</Text>
        </View>
      </View>
      <View style={styles.View_2_62}>
        <View style={styles.View_2_63}>
          ...
          <ImageBackground
            source={{
              uri:
                "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/e3408077-f36e-4d79-aa43-4255a7f4ff10"
            }}
        ...
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/2b9d9f62-5ecc-405b-9f4c-092565ef8e9c"
          }}
        ...
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/8ddf82dc-964b-4db3-b725-a4e6798eb291"
          }}
          style={styles.ImageBackground_2_71}
        />
        <View style={styles.View_2_76}>
          <View style={styles.View_2_77}>
            <Text style={styles.Text_2_77}>08:00</Text>
          </View>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  View_2_55: {
    ...
    left: wp("9%"),
    top: hp("80%"),
    backgroundColor: "rgba(216, 243, 255, 1)",
